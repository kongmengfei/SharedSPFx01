...
import styles from './Panelmeettab.module.scss';
import { DefaultButton, IconButton, Modal } from 'office-ui-fabric-react';
import { IPanelmeettabProps } from './IPanelmeettabProps';
import { IPanelmeettabState } from './IPanelmeettabState';

export default class Panelmeettab extends React.Component<IPanelmeettabProps, IPanelmeettabState> {

  constructor(props: IPanelmeettabProps) {
    super(props);
  ...
  public render(): React.ReactElement<IPanelmeettabProps> {
    return (
      <div className={styles.panelmeettab}>
